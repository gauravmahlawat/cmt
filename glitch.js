...
function oe(_) {
    for (var a = _, $ = [], ee = [], te = [], i = 768; i <= 789; i++)
        $.push(String.fromCharCode(i));
    for (i = 790; i <= 819; i++)
        794 != i && 795 != i && te.push(String.fromCharCode(i));
    for ($.push(String.fromCharCode(794)),
    $.push(String.fromCharCode(795)),
    i = 820; i <= 824; i++)
        ee.push(String.fromCharCode(i));
    for (i = 825; i <= 828; i++)
        te.push(String.fromCharCode(i));
    for (i = 829; i <= 836; i++)
        $.push(String.fromCharCode(i));
    $.push(String.fromCharCode(836)),
    te.push(String.fromCharCode(837)),
    $.push(String.fromCharCode(838)),
    te.push(String.fromCharCode(839)),
    te.push(String.fromCharCode(840)),
    te.push(String.fromCharCode(841)),
    $.push(String.fromCharCode(842)),
    $.push(String.fromCharCode(843)),
    $.push(String.fromCharCode(844)),
    te.push(String.fromCharCode(845)),
    te.push(String.fromCharCode(846)),
    $.push(String.fromCharCode(848)),
    $.push(String.fromCharCode(849)),
    $.push(String.fromCharCode(850)),
    te.push(String.fromCharCode(851)),
    te.push(String.fromCharCode(852)),
    te.push(String.fromCharCode(853)),
    te.push(String.fromCharCode(854)),
    $.push(String.fromCharCode(855)),
    $.push(String.fromCharCode(856)),
    te.push(String.fromCharCode(857)),
    te.push(String.fromCharCode(858)),
    $.push(String.fromCharCode(859)),
    te.push(String.fromCharCode(860)),
    $.push(String.fromCharCode(861)),
    $.push(String.fromCharCode(861)),
    te.push(String.fromCharCode(863)),
    $.push(String.fromCharCode(864)),
    $.push(String.fromCharCode(865));
    for (var b = "", c = 0; c < a.length; c++) {
        var d = a.charAt(c);
        if (!/\s/.test(d)) {
            d += ee[Math.floor(Math.random() * ee.length)];
            for (var ne = $.length - 1, oe = 0, re = 10 - 10 * Math.random(); oe < re; oe++)
                d += $[Math.floor(Math.random() * ne)];
            for (var ie = te.length - 1, oe = 0, re = 10 - 10 * Math.random(); oe < re; oe++)
                d += te[Math.floor(Math.random() * ie)]
        }
        b += d
    }
    return b = b.replace(/\n/g, "<br>")
...
function _() {
    var _ = content.value
      , $ = ""
      , ee = oe(_ = "" == _ ? content.placeholder : _);
    if ("object" == typeof ee)
        for (var te in ee)
            isNaN(te) && ($ += "<h3>" + te + "</h3>"),
            $ += "<p>" + ee[te] + ne + "</p>";
