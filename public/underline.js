...
t.FileSaver = {});
var t, e, te, ie = ["/22181265/ConvertCase_728x90_ATF", "/22181265/ConvertCase_300x250_Belowtxtbox_1", "/22181265/ConvertCase_300x250_Belowtxtbox_2"], oe = '<img src="/img/copy.svg" class="copy" alt="Copy to Clipboard">';
function ue(_, $) {
    var ee;
...
function _() {
    var ee, _ = content.value, $ = ("" == _ && (_ = content.placeholder),
    ""), te = (ee = "̲",
    _.split("").reduce(function(_, $) {
        return _ + $ + ee
    }, "").replace(/\n/g, "<br>"));
    if ("object" == typeof te)
        for (var ne in te)
